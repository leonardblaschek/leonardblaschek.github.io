...
cat(paste0("<br>Powered by the free and open source scholarly indexing project [OpenAlex](https://openalex.org).<br><i>Last updated ", floor_date(as_date(full_profile[["updated_date"]])), ".</i>"))
```