...
\hspace{1em}  \textbf{Monroe JG}, Turner K, Gill B. Remotely sensed drought frequency predicts life history evolution in genus \textit{Heliophila}. Manuscript in prep.
\vspace{1ex}\par
\hspace{1em}  \textbf{Monroe JG}, Price N, McKay JK. Loss-of-function in \textit{Arabidopsis thaliana} contributes to flowering time evolution along satellite detected drought frequency gradients. Manuscript in prep.
\vspace{1ex}\par
\hspace{1em}  \textbf{Monroe JG}, Markman DW, Beck WS, Felton AJ, Vahsen ML, Pressler Y. 2017. Eco-evolutionary Dynamics of Carbon Cycling in the Anthropocene. \textit{Trends in Ecology and Evolution}. Manuscript in review.
\vspace{1ex}\par
...
\subsubsection*{PROFESSIONAL ENGAGEMENT}
\vspace{-0.5ex}\par
...
\par
\hspace*{2.0em} Evolution, New Phytologist
