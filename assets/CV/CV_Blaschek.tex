...
\begin{itemize}[label={},itemindent=-9pt,leftmargin=24pt]
	\itemsep-0.1cm
	\item Pesquet E, \textbf{Blaschek L}, Takahashi J,	Yamamoto M, Champagne A, Nuoendagula, Subbotina E, Dimotakis C, Bacsik Z, Kajita S. Bulk and In Situ Quantification of Coniferaldehyde Residues in Lignin: Analysis of Coniferaldehyde Units in Plant Lignin Polymers. In: Agusti J (eds), \textit{Methods in Molecular Biology. In press.}
...
\begin{itemize}[label={},itemindent=-9pt,leftmargin=24pt]
	\itemsep-0.1cm
	\item \textbf{Blaschek L} (2023).  Freiburg Rising Stars Academy, cohort 2023/24. 
	\item \textbf{Blaschek L} (2023). Groupe Polyphénols Ragaï Ibrahim prize at the \textit{31\textsuperscript{st} International Conference on Polyphenols.}
	...
	\item \textbf{Blaschek L} (2021). Best student presentation award at the \textit{7\textsuperscript{th} International Conference on Plant Cell Wall Biology.}
	\item \textbf{Blaschek L} (2019). Travel grant of the Department of Ecology, Environment and Plant Sciences, Stockholm University to attend the \textit{28\textsuperscript{th} Congress of the Scandinavian Plant Physiology Society.}
