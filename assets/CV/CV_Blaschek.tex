...
\begin{itemize}[label={},itemindent=-9pt,leftmargin=24pt]
	...
	\item Ménard D\textsuperscript{$\dagger$}, \textbf{Blaschek L}\textsuperscript{$\dagger$}, Zhong C, Kriechbaum K, Lee CC, Nuoendagula, Kajita S, Mathew A, Pesquet E. (\textit{In preparation}). Lignin Ensures the Biomechanical Properties of Xylem Vessels under Tension.
\end{itemize}
