...
\begin{itemize}[label={},itemindent=-9pt,leftmargin=24pt]
	\itemsep-0.1cm
	\item \textbf{Blaschek L} (2021). Laccase paralogs non-redundantly direct lignification. \textit{ASPB Plant Biology 2021,} Online --- \textit{selected talk}
	\item \textbf{Blaschek L} (2021). Specific and dynamic lignification at the cell-type level controls plant physiology and adaptability. \textit{SEB 2021 Annual Conference,} Online --- \textit{selected talk}
	\item \textbf{Blaschek L} (2021). Laccase paralogs non-redundantly direct lignification. \textit{SEB 2021 Annual Conference,} Online --- \textit{selected talk}
	\item \textbf{Blaschek L} (2021). Laccase paralogs non-redundantly direct lignification. \textit{7\textsuperscript{th} International Conference on Plant Cell Wall Biology,} Online --- \textit{selected talk \& best student presentation award}
	\item \textbf{Blaschek L} (2019). The structural importance of lignin in xylem vessels. \textit{3\textsuperscript{rd} Stockholm Cell Wall Meeting}, Stockholm University, Stockholm --- \textit{selected talk}
	\item \textbf{Blaschek L} (2019). Spatial distribution of coniferaldehyde lignin. \textit{28\textsuperscript{th} Congress of the Scandinavian Plant Physiology Society}, Umeå --- \textit{selected talk}
	\item \textbf{Blaschek L} (2018). Determining the spatial distribution of aldehyde units in lignin. \textit{2\textsuperscript{nd} Stockholm Cell Wall Meeting}, KTH Royal Institute of Technology, Stockholm --- \textit{selected talk}
\end{itemize}
\vspace{0.3cm}

\noindent{\Large \textsc{Grants \& Scholarships} \normalsize}
\vspace{-0.175cm}
\begin{itemize}[label={},itemindent=-9pt,leftmargin=24pt]
	\itemsep-0.1cm
