...
\begin{itemize}[label={},itemindent=-9pt,leftmargin=24pt]
	...
	\item \textbf{Blaschek L} (2021). Best student presentation award at the \textit{7\textsuperscript{th} International Conference on Plant Cell Wall Biology,} online.
\end{itemize}
\vspace{0.3cm}
...
\begin{addmargin}[24pt]{0pt}
	\begin{multicols}{2}
		...
		\begin{itemize}[itemindent=-9pt,leftmargin=24pt]
			...
			\item protein expression \& purification, Western blotting, enzyme activity assays, (phospho-)proteomics
			\item RT-qPCR
