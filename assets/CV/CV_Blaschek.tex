...
\begin{itemize}[label={},itemindent=-9pt,leftmargin=24pt]
	\itemsep-0.1cm
	\item Low PM\textsuperscript{$\dagger$}, Kong Q\textsuperscript{$\dagger$}, \textbf{Blaschek L}\textsuperscript{$\dagger$}, Ma Z, Lim PK, Yang Y, Quek T, Lim CJR, Singh SK, Crocoll C, Engquist E, Thorsen JS, Pattanaik S, Tee WT, Mutwil M, Miao Y, Yuan L, Xu D, Persson S*, Ma W*. ZINC FINGER PROTEIN2 suppresses funiculus lignification to assure seed loading efficiency. \textit{In press (Dev. Cell).}
\end{itemize}
...
\begin{itemize}[label={},itemindent=-9pt,leftmargin=24pt]
	\itemsep-0.1cm
	\item \textbf{Blaschek L*}, Serk H, Pesquet E. Functional complexity on a cellular scale: why \textit{In situ} analyses are indispensable for our understanding of lignified tissues. \textit{J. Agric. Food. Chem.} 72, 13552--13560. \href{https://doi.org/10.1021/acs.jafc.4c01999}{10.1021/acs.jafc.4c01999}
...
\begin{itemize}[label={},itemindent=-9pt,leftmargin=24pt]
	\itemsep-0.1cm
	\item \textbf{Blaschek L} (2025), invited talk. Random? How laccases adjust lignification to support plant growth. \textit{Groupe Polyphénols Webinar in Polyphenols Research,} online.
